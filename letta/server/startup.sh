...
# DNS-over-TCP is now handled by RES_OPTIONS=use-vc in the compose
# environment, which glibc reads at resolver init. No need to write
# to /etc/resolv.conf at runtime.
